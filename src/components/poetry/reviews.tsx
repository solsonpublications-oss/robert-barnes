...
export function Footer() {
  ...
  const socials = [
    ...
    { href: "https://www.amazon.com/stores/author/B00QJ4O3CW", label: "Amazon Author Page", icon: ShoppingBag },
  ];
  return (
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 text-center">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-xs tracking-wide text-muted-foreground">
            © 2026{" "}
            <a
              href="https://www.RRayBarnesProductions.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary/90 transition-colors hover:text-primary hover:underline underline-offset-4"
            >
